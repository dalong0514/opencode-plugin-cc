...
allowed-tools: Bash(node:*), Bash(npm:*), Bash(bun:*), AskUserQuestion
---
...
- If opencode is installed but has no providers configured, preserve the guidance to run `!opencode auth login`.
